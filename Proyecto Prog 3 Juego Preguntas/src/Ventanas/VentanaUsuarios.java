	...
	private void initialize() {
		...
		btnMarcadores.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				logger.log( Level.INFO, "Bot�n Marcadores");
		...
		btnInstrucciones.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				logger.log( Level.INFO, "Bot�n Instrucciones");
				JOptionPane.showMessageDialog(null,
						"Bienvenido a Questions4Millions!\n"
								+ "Q4M es un juego de preguntas y respuestas donde deber�s contestar"
								+ "a todas las preguntas dentro de un l�mite de tiempo "
								+ "mientras se incrementa la dificultad de estas.\n"
								+ "Tu objetivo ser� contest�r m�s preguntas que tus rivales y llevarte el gran premio.\n"
								+ "Mucha suerte!",
		...
		btnSalir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				logger.log( Level.INFO, "Bot�n Salir");
				bd.desconectar();
				System.exit(0);
			}
		});
		...
		btnAdmin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				logger.log( Level.INFO, "Bot�n Administracion");
